...
struct ToolbarAction: Identifiable {
    ...
    /// The shelve action is labeled by its target: Snag's built-in stash (the default) or a shelf app.
    var title: String {
        id == .shelve && Defaults[.shelfApp] == SNAG_STASH_APP ? "Stash" : staticTitle
    }
