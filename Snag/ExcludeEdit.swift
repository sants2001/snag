...
/// A countable approximation of an exclusion rule: a Snag search query plus optional folder scope.
...
/// Translate one (possibly edited) exclusion rule into a Snag query that counts how many indexed items it
